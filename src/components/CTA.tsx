      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight uppercase">
            Ready to Start Your{" "}
            <span className="text-accent-purple">Project</span>?
          </h2>
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Let's collaborate to create something extraordinary. We're here to
            turn your vision into a reality that drives results.
          </p>
          <div>
            <Button
