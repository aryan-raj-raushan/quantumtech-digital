...
const AnimatedCounter = ({ to, suffix }: any) => {
...
const defaultStats = [
  {
    ...
    description:
      "Delivered across 20+ countries—from startups to top corporations.",
  },
  {
    value: 100,
    suffix: "%",
    ...
    description:
      "Clients reporting enhanced efficiency with our custom strategies.",
  },
  {
    value: 300,
    suffix: "+",
    label: "AI innovation",
    description:
      "Hours spent crafting smart AI tools to optimize workflows across key industries.",
  },
  {
    value: 75,
    suffix: "+",
    ...
    description:
      "Recognized for design, tech, and sustainability—past five years.",
  },
];

const Stats = ({ customStats }: any) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="flex items-end">
              <p className="text-lg text-gray-400 max-w-md">
                ...
                that scale, optimize, and save valuable hours.
              </p>
            </div>
          </div>
        )}
